<html>
    ...
    <body bgcolor="#efefef">
        ...
        <table id="wrapper" cellspacing="1" cellpadding="10" bgcolor="#cccccc" align="center"><tbody><tr><td bgcolor="#ffffff">
                        ...
                        <table cellspacing="0" id="invoiceitemstable" align="center">
                            <tbody>
                                ...
                                ?>
                                <tr bgcolor="#ffffff">
                                    <td id="invoiceitemsrow" style="border:1px solid #cccccc;border-bottom:0px;"><?php echo $v_order_detail_info->product_name;?></td>
                                    <td align="center" id="invoiceitemsrow" style="border:1px solid #cccccc;border-bottom:0px;border-left:0px;"><?php echo $v_order_detail_info->product_price;?></td>
                                    <td id="invoiceitemsrow" style="border:1px solid #cccccc;border-bottom:0px;"><?php echo $v_order_detail_info->product_sales_quantity;?></td>
                                    <td align="center" id="invoiceitemsrow" style="border:1px solid #cccccc;border-bottom:0px;border-left:0px;"><?php $product_price = $v_order_detail_info->product_price; $product_qty = $v_order_detail_info->product_sales_quantity; $subtotal_price=$product_price*$product_qty; echo $subtotal_price;?></td>
                                </tr>
        ...
        <p align="center"><a href="<?php echo base_url();?>super_admin/manage_order">Back to Admin Panel</a> | <a href="#">Download</a> | <a href="javascript:window.close()">Close Window</a></p>
