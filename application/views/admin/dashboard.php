            ...
            <div class="widget-body">
                <div class="timeline-messages">
                    ...
                    <div class="msg-time-chat">
                        <a class="message-img" href="#"><img alt="" src="<?php echo base_url(); ?>admin/img/avatar1.jpg" class="avatar"></a>
                    ...
                    Comment 
                    <div class="msg-time-chat">
                        <a class="message-img" href="#"><img alt="" src="<?php echo base_url(); ?>admin/img/avatar2.jpg" class="avatar"></a>
